package org.pchrzasz.store.config;
...
@Configuration
@EnableMongoRepositories("org.pchrzasz.store.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("org.pchrzasz.store.config.dbmigrations");
